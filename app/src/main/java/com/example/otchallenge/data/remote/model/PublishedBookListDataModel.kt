package com.example.otchallenge.data.remote.model

import com.google.gson.annotations.SerializedName

/**
 * Data class representing the response from the API for a list of published books
 */
data class PublishedBookListResponse(
    @SerializedName("status") val status: String,
    @SerializedName("copyright") val copyright: String,
    @SerializedName("num_results") val numResults: Int,
    @SerializedName("last_modified") val lastModified: String,
    @SerializedName("results") val resultsBookList: BookResultsModel
)

// Data class representing the results of the published book list
data class BookResultsModel(
...
// Data class representing a book in the list
data class Book(
